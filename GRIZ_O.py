...
#_________________________________________________________________________
    ...
    time.sleep(0.3)
    print('\033[1;31m[16] \033[1;34m Follow us on our channel  ')
    time.sleep(0.3)
...
######################################################################
    ...
    os.system('clear')
    print(banner)
    webbrowser.open('https://t.me/Dark_Lord7x')
    jalan("Just wait ........")
    os.system('am start -a android.intent.action.VIEW -d "https://t.me/Dark_Lord7x"')
    os.system('clear')
    print(banner)
############################################################################################